...
<html>
    ...
    <head>
        ...
        <title>{{ $site->title ?? "Card Generator" }}</title>
        ...
        <link rel="shortcut icon" href="{{ asset(isset($site) && $site->favicon ? $site->favicon : 'frequent_changing/images/logo/favicon.png') }}" type="image/x-icon">
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="pen-title">
                    <img src="{{ asset(isset($site) && $site->logo ? $site->logo : 'frequent_changing/images/logo/logo.png') }}" class="CG-Logo">
                </div>
                @yield('content')
            </div>
        </div>
